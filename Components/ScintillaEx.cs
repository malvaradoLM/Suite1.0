...
namespace RPSuite.Componentes
{
    public class ScintillaEx : Scintilla
    {
        ...
        public ScintillaEx()
        {
            ...
            this.Enter += (object sender, EventArgs e) => this.EnterComponent();
            this.Leave += (object sender, EventArgs e) => this.LeaveComponent();
        ...
        {
            RPSuite.Data.DataModule.OKEnter = false;
        }

        protected virtual void LeaveComponent()
        {
            RPSuite.Data.DataModule.OKEnter = true;
        }
